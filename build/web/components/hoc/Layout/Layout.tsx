  ...
  return (
    <>
      ...
      <svg className={styles.tracker} viewBox="0 0 24 437">
        <motion.path
          fill="#45A29E"
          d="M12,418c5.5,0,10,4.3,10,9.5s-4.5,9.5-10,9.5s-10-4.3-10-9.5S6.5,418,12,418z"
      ...
      <footer>
        <div>
          ...
          <a href={'https://vimeo.com/user18858319'} target="_blank">
            Vimeo -{' '}
          </a>
          <a href={'https://www.linkedin.com/feed/'} target="_blank">
            Linkedin -{' '}
          </a>
          <a href={'https://www.instagram.com/fredcorr_/'} target="_blank">
            Instagram -{' '}
          </a>
          <a href={'https://twitter.com/FedericoCorra16'} target="_blank">
            Twitter
          </a>
        </div>
        <div>
          <p>104 Agar Grove, London, United Kingdom</p>
